...
file_object = open('./TM/item-detail-base-02.txt', "a", encoding='utf-8')
# 干扰函数
...
def getUrlDetailUrlFromDB(category):
    # headers 游标
    headersIndex = 0
    dataReptiledb.init(None, "./logs/db-getBaseData.log")
    # 获取数据库中的 headers
...
if __name__ == '__main__':
    ...
    threading.Thread(target=getUrlDetailUrlFromDB, args=('管理学',), name="管理学").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('公务员考试',), name="公务员考试").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('教辅与教材',), name="教辅与教材").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('心理学',), name="心理学").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('婚恋两性',), name="婚恋两性").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('成功励志',), name="成功励志").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('英语考试',), name="英语考试").start()
    threading.Thread(target=getUrlDetailUrlFromDB, args=('时尚美容',), name="时尚美容").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('工业技术',), name="工业技术").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('少儿早教',), name="少儿早教").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('计算机与网络'), name="计算机与网络 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('7-14岁少儿'), name="7-14岁少儿 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('青春与动漫绘本'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('建筑'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('大中专教辅-中职'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('教辅'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('工具书'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('童话故事'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('农林业'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('经济与金融'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('0-3岁低龄'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('运动健身'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('学习考试'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('大中专教辅-公开课'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('旅游与地图'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('生活'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('美食'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('军事'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('奥赛'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('童书'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('社会科学'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('运动与健身'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('经济管理'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('小说'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('家庭教育'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('文学'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('哲学与宗教'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('历史'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('大中专教辅-理科'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('艺术与摄影'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('外语学习与考试'), name="管理学 ").start()
    # threading.Thread(target=getUrlDetailUrlFromDB, args=('法律'), name="管理学 ").start()
